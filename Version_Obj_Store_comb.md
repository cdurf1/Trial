...
<a id="7b"></a>
![HLD_Graphics/Fig_009.png](HLD_Graphics/Fig_009.png "Interfaces for enumeration KV and Byte array objects")
...
![HLD_Graphics/Fig_011.png](HLD_Graphics/Fig_011.png "Red Black Tree based KV Store with Multi-Key")
...
![HLD_Graphics/Fig_012.png](HLD_Graphics/Fig_012.png "Example of extents and epochs in a byte array object")
...
![HLD_Graphics/Fig_013.png](HLD_Graphics/Fig_013.png "Example RB Tree based extent tree Construction for Input from Table 5 3. (a) Shows tree after first three inserts and (b) shows the complete tree with additional inserts during overlap")
...
![HLD_Graphics/Fig_014.png](HLD_Graphics/Fig_014.png "Example showing extensive splitting of extent ranges during overwrites")
...
![HLD_Graphics/Fig_015.png](HLD_Graphics/Fig_015.png "Example of four Storage Nodes, eight DAOS Targets and three DAOS Pools")
...
![HLD_Graphics/Fig_016.png](HLD_Graphics/Fig_016.png "Rectangles representing extent_range.epoch_validity arranged in 2-D space for an order-4 EV-Tree using input in the table")
...
![HLD_Graphics/Fig_017.png](HLD_Graphics/Fig_017.png "Rectangles representing extent_range.epoch_validity arranged in 2-D space for an order-4 EV-Tree using input in the table")
...
![HLD_Graphics/Fig_018.png](HLD_Graphics/Fig_018.png "Pictorial representation of Split scenarios of rectangles in EV-Tree")
...
![HLD_Graphics/Fig_019.png](HLD_Graphics/Fig_019.png "Pseudo Code showing Split Conditions for Rectangle")
...
![HLD_Graphics/Fig_020.png](HLD_Graphics/Fig_020.png "Layers of a  Document store. Value of Key Tree form separate atomic/partial value trees")
...
<a id="7p"></a>
![HLD_Graphics/Fig_021.png](HLD_Graphics/Fig_021.png "Example of four Storage Nodes, eight DAOS Targets and three DAOS Pools") 
...
![HLD_Graphics/Fig_022.png](HLD_Graphics/Fig_022.png "Architecture of NVML on persistent memory using a PM-Aware File System")
...
![HLD_Graphics/Fig_023.png](HLD_Graphics/Fig_023.png "Code block showing the creation of root object for VOS using NVML pointers")
...
![HLD_Graphics/Fig_024.png](HLD_Graphics/Fig_024.png "Code block showing TOID macros for defining typed pointers in NVML")
 
<a id="7t"></a>

<b>Internal Representation of List Entry Macros in NVML</b>

![HLD_Graphics/Fig_025.png](HLD_Graphics/Fig_025.png "Internal Representation of List Entry Macros in NVML")
